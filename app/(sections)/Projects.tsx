  ...
  return (
    <section id="projects" className="py-24 md:py-20 px-4 sm:px-6 bg-slate-900/50 scroll-mt-24 md:scroll-mt-28">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-4 bg-linear-to-r from-teal-300 to-emerald-400 bg-clip-text text-transparent leading-tight">
          Proyectos Destacados
        </h2>
        <div className="w-24 h-1 rounded-full bg-linear-to-r from-teal-400 to-emerald-500 mx-auto mb-8" />
        <p className="text-center text-slate-400 mb-12 md:mb-16 max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">
          Aplicaciones web desarrolladas end-to-end con <span className="text-teal-400 font-medium">tecnologías modernas</span> y mejores prácticas de desarrollo
        </p>
          ...
          {featured.map((project) => (
            ...
            >
              <motion.div
                ...
                className="relative h-full flex flex-col bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700 hover:border-teal-500/40 transition-colors duration-500 ease-out overflow-hidden hover:shadow-xl hover:shadow-teal-500/15"
              >
                {/* Image Section */}
                <div className="relative h-48 sm:h-52 md:h-64 overflow-hidden">
                  ...
                  >
                    <span className="px-4 py-1.5 bg-teal-600/90 backdrop-blur-sm text-white text-sm font-semibold rounded-full border border-teal-400/30">
                      {project.category}
                    </span>
                  </motion.div>
                  ...
                  <div className="absolute top-4 right-4 flex gap-2 opacity-85 md:opacity-0 md:translate-y-1 md:group-hover:translate-y-0 md:group-hover:opacity-100 transition-all duration-500 ease-out">
                    ...
                    {project.liveUrl && (
                      <motion.a
                        ...
                        whileHover={{ scale: 1.08 }}
                        whileTap={{ scale: 0.96 }}
                        className="p-3 bg-linear-to-r from-teal-600/90 to-emerald-600/90 hover:from-teal-500 hover:to-emerald-500 backdrop-blur-sm rounded-lg transition-all duration-300 hover:scale-110 border border-teal-400/30"
                ...
                <div className="p-5 sm:p-6 md:p-8 flex-1 flex flex-col">
                  {/* Title and Period */}
                  <div className="mb-4">
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-teal-100 mb-2 group-hover:text-teal-300 transition-colors leading-tight">
                      {project.title}
                    </h3>
                  ...
                  <div className="mb-6 mt-4">
                    <motion.button
                      ...
                      whileHover={{ x: 2 }}
                      whileTap={{ scale: 0.98 }}
                      className="cursor-pointer text-sm font-semibold text-emerald-400 hover:text-emerald-300 transition-colors"
                    >
                  ...
                  <div className="mb-5 md:mb-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech, index) => (
                        <span
                          key={index}
                          className="px-4 py-2 bg-linear-to-r from-teal-500/10 to-emerald-500/10 text-teal-300 rounded-lg text-sm border border-teal-500/20 font-medium hover:border-teal-400/50 hover:bg-teal-500/20 transition-all duration-300"
                        >
                          {tech}
                        </span>
                      ))}
                  ...
                  <div className="mt-auto flex flex-col sm:flex-row gap-3 pt-4 border-t border-slate-700">
                    {project.liveUrl && (
                      <motion.a
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="flex-1 flex items-center justify-center gap-2 px-5 py-3 bg-linear-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 text-white font-semibold rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-teal-500/30"
                      >
        ...
        {academic.length > 0 && (
          <div className="mt-20">
            <h3 className="text-2xl font-bold text-slate-300 mb-2">Proyectos Académicos</h3>
              ...
              {academic.map((project) => (
                ...
                >
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <div>
                      <h4 className="text-teal-100 font-semibold">{project.title}</h4>
        ...
        <div className="mt-16 text-center bg-slate-800/30 backdrop-blur-sm border border-slate-700 rounded-xl p-8">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-3 bg-linear-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-teal-500/30"
          >
